...
const DashboardHero = ({ onTryDemo, onCreateNew, onDismiss }: DashboardHeroProps) => {
    return (
        <section className="dashboard-hero relative mb-10 grid items-center gap-8 rounded-3xl border border-primary/10 bg-gradient-to-br from-primary/[0.06] via-transparent to-transparent p-5 sm:p-7 md:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)]">
            <Button
                type="button"
                variant="ghost"
                size="icon-sm"
