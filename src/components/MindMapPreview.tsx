...
const MindMapPreview = () => {
    return (
        <div className="mindmap-preview relative overflow-hidden rounded-2xl border border-primary/15 bg-card/80 shadow-[0_20px_50px_-24px_color-mix(in_oklch,var(--primary)_45%,transparent)]">
